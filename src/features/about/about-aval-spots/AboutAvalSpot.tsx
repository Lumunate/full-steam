...
const AboutAvalSpots: React.FC = () => {
  ...
  return (<Box sx={{position: 'relative'}} >
    <Image  src='/about/how-it-is-section/family-with-dog.png' height={557} width={895} alt='Light Bulb' style={{position: 'absolute', zIndex: 0, top: '25%', left: '0'}}  />
    <AppContentWrapper sx={{zIndex: 5}} >
      <AboutWrapper sx={{position: 'relative' , display:'flex' , justifyContent: 'flex-end'}} >
        <Box sx={{display: 'flex', flexDirection: 'column', position:'relative'}}>
          <SectionHeading text="How It Works" align="start" marginBottom="23px" />
          <SectionMainHeading marginbottom = '0'  text="For Daycares with " span="Available Spots"  />
          <AboutSubHeading >
          ...
          <Image  src='/about/how-it-is-section/sucess-together.png' height={272} width={272} alt='Light Bulb' style={{position: 'absolute', zIndex: 0, top: '65%', right: '-18%'}}  />
          <AboutSubHeading >
          Monthly Advertising Fee
          </AboutSubHeading>
          <ImpressionCard text='Daycares can list their available spots for a $10 monthly fee, which covers promotion to interested families and helps maintain the platform.' imageUrl='/about/icons/map.svg' />
