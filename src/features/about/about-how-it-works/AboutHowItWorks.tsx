...
import { ParentsImage } from './AboutHowItWorks.style';
import { HowItWorksBox } from './AboutHowItWorks.style';
  ...
  return (
    <AppContentWrapper>
      <FadeIn>
        ...
        <HowItWorksBox >
          {/* <FadeIn direction='left' duration={1.5} distance={100}> */}
          ...
          {/* <FadeIn direction='right' duration={1.5} distance={100}> */}
