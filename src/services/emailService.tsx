...
// Console log to debug API key (remove in production)
...
class EmailService {
  async sendRegistrationEmail({ to, name }: RegistrationEmailProps) {
    try {
  ...
  async sendApprovalEmail({ to, name }: ApprovalEmailProps) {
    try {
  ...
  async sendAccountActivatedEmail({ to, name }: AccountActivatedEmailProps) {
    try {
  ...
  async sendResetPasswordEmail({ to, resetToken }: ResetPasswordEmailProps) {
